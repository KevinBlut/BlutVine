...
constexpr const char* kChromiumVersions = "147.0.7727.55";

// Default versions for Client Hints (Sec-CH-UA)
constexpr const char* kChromeDefaultVersion = "147.0.7727.55";
constexpr const char* kEdgeDefaultVersion = "147.0.3912.51";
...
constexpr const char* kEdgeUAVersion = "147.0.0.0";
