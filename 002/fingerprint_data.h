...
constexpr const char* kChromeDefaultVersion = "146.0.7680.80";
constexpr const char* kEdgeDefaultVersion = "146.0.3856.59";
constexpr const char* kOperaDefaultVersion = "128.0.5807.52";
constexpr const char* kVivaldiDefaultVersion = "7.8.3925.76";
...
constexpr const char* kVivaldiUAVersion = "7.8.3925.76";
